...
--
-- Name: filmCategory; Type: TABLE; Schema: public; Owner: -
--
...
CREATE VIEW public.actor_info AS
 SELECT a."actorId",
    ...
    public.group_concat(DISTINCT ((c.name || ': '::text) || ( SELECT public.group_concat(f.title) AS group_concat
           FROM ((public.films f
             JOIN public."filmCategory" fc_1 ON ((f."filmId" = fc_1."filmId")))
   ...
   FROM (((public.actors a
     ...
     LEFT JOIN public."filmCategory" fc ON ((fa."filmId" = fc."filmId")))
...
CREATE VIEW public.film_list AS
 SELECT films."filmId" AS fid,
   ...
   FROM ((((public.genres
     LEFT JOIN public."filmCategory" ON ((genres."genreId" = "filmCategory"."genreId")))
     LEFT JOIN public.films ON (("filmCategory"."filmId" = films."filmId")))
...
CREATE VIEW public.sales_by_film_genre AS
 SELECT c.name AS genres,
   ...
   FROM (((((public.payments p
     ...
     JOIN public."filmCategory" fc ON ((f."filmId" = fc."filmId")))
...
--
-- Name: filmCategory film_genre_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: filmCategory last_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER last_updated BEFORE UPDATE ON public."filmCategory" FOR EACH ROW EXECUTE PROCEDURE public.last_updated();
...
--
-- Name: filmCategory film_genre_genre_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: filmCategory film_genre_film_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
