  ...
  render() {
    return (
      <div>
        ...
        <p className={this.state.htmlDescOpen ? 'description' : 'hidden'}></p>
        <div>
          <button onClick={this.cssClick}>Cascading Style Sheets</button>
          <p className={this.state.cssDescOpen ? 'description' : 'hidden'}></p>
        </div>
        <button onClick={this.jsClick}>JavaScript</button>
        <p className={this.state.jsDescOpen ? 'description' : 'hidden'}></p>
      </div>
    )
  }
}
